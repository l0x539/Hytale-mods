...
import { do_logout, get_user_status } from '../../axios/functions';
...
class Navbar extends Component {
  ...
  render() {
    ...
    // if login change
    if (this.state.loggedin === true || window.loggedIn) {
      return (
        <React.Fragment>
          <nav className="navbar" onMouseMove={this.updateNav}>
            <div className="navbar__container">
              ...
              <div className={navRenderedClass}>
                ...
                <div className="nav__button-container">
                  ...
                  }} className="nav__button--primary">Account </Link>
                  <Link to={{
                    pathname: "/"
                  }} onClick={this.handleLogout} className="nav__button">Logout</Link>
                </div>
